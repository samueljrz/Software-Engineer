...
var SignInController = /** @class */ (function () {
    ...
    SignInController.prototype.authenticate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var repository, _a, email, senha, user, isValidPass, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bcryptjs_1.default.compare(senha, user.senha)];
                    case 2:
                        isValidPass = _b.sent();
                        if (!isValidPass) {
                            return [2 /*return*/, res.sendStatus(401)];
                        }
                        token = jsonwebtoken_1.default.sign({ id: user.cpf }, 'secret', { expiresIn: '1d' });
                        delete user.senha;
